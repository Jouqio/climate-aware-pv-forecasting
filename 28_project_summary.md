...
PHASE 2 — Implementation     → Notebooks NB01–NB10 + run_pipeline.py
...
| File | Purpose | Status |
|---|---|---|
| 01_data_preprocessing.py | NASA POWER parsing | ✅ Complete |
| 02_target_reconstruction.py | Stochastic target (7 components) | ✅ Complete |
| 03_feature_engineering.py | 12 features + VIF + ONI | ✅ Complete |
| 04_validation_framework.py | Walk-forward splits + metrics | ✅ Complete |
| 05_ols_hc3_model.py | OLS-HC3 + full diagnostics | ✅ Complete |
| 06_sarimax_climate_model.py | SARIMAX + ONI + PI | ✅ Complete |
| 07_xgboost_model.py | XGBoost constrained | ✅ Complete |
| 08_shap_analysis.py | SHAP + XAI correspondence | ✅ Complete |
| 09_residual_diagnostics.py | DM + Friedman + KW + Chow | ✅ Complete |
| 10_figure_generation.py | 13 publication figures | ✅ Complete |
...
*Research conducted entirely on NASA POWER public reanalysis data.*
*All code open-source, seed documented (42), 15-scenario sensitivity verified.*
*Pipeline reproducible in ~90 minutes on standard hardware.*
